...
namespace WindowsFormsApp1
{
   class Scan
   {
      public static DataTable calculate(double alpha, double beta, double mu, double pressure, double speed, double consumption, double[] tempT1, double[] tempT2, double accuracy, double step)
      {
